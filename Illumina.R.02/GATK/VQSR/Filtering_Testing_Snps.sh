#!/bin/bash
#SBATCH --mem=100G
cd   ~/work/WG_phasing/Illumina.R.02/GATK/VQSR
zcat Snps.recalibrated.vcf.gz|grep -P '#|PASS' >pass_filtered_VQSR_SNPs.vcf
java -jar /home/knam/work/WG_phasing/java_programs/Snps_testing_distRef.jar  "/home/knam/work/WG_phasing/Illumina.R.02/GATK/VQSR/pass_filtered_VQSR_SNPs.vcf" "/home/knam/save/WG_phasing/data_prep/simulation/fasta/right.position.txt" "/home/knam/work/WG_phasing/distant_ref/R_0.02.refseq2simseq.SNP.vcf" "/home/knam/work/WG_phasing/Illumina.R.02/GATK/Snp_testing/GATK_VQSR_Snp_testing.R.02.txt"
...
gzip -f /home/knam/work/WG_phasing/Illumina.R.02/GATK/Snp_testing/GATK_VQSR_Snp_testing.R.02.txt
