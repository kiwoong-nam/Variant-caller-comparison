...
my $input='/home/knam/work/WG_phasing/Illumina_VQSR/Training/vcf/Gatk_Illumina_Snps.vcf.gz';
my $output='/home/knam/work/WG_phasing/Illumina_VQSR/Training/Snp_testing/Gatk_Illumina_Snps.scores.txt';
